 ...
 * operations. It provides methods for creating, retrieving, updating, and managing
 * FCARs, acting as an intermediary between the UI and the FCAR data.
 */
public class FCARController {
    ...
    public List<FCAR> getAllFCARs() {
        Map<String, FCAR> allFCARs = FCARFactory.getAllFCARs();
        // Update the cache with all FCARs
        this.fcarCache.putAll(allFCARs);
        return new ArrayList<>(allFCARs.values());
    }

    // Other methods such as getFCARsForCourse, getFCARsByProfessor, etc.
